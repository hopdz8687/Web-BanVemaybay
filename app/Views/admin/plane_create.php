    ...
    <div class="col-md-8">
      <div class="card shadow">
        <div class="card-header bg-gradient" style="background: linear-gradient(135deg, #667eea, #764ba2);">
          <h4 class="text-dark mb-0"><i class="bi bi-plus-circle"></i> Thêm Máy Bay</h4>
        </div>
        <div class="card-body p-4">
          ...
          <form method="post" action="<?=base_url('/admin/planes/create')?>">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="ma_may_bay" class="form-control form-control-lg" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Tên máy bay</label>
              <input type="text" name="ten_may_bay" class="form-control form-control-lg" required>
            </div>
            <div class="d-flex gap-2 pt-3">
              <button type="submit" class="btn btn-lg btn-success flex-grow-1">
                <i class="bi bi-check-circle"></i> Tạo Máy Bay
              </button>
